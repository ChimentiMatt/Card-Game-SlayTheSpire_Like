...
const Hand = ({card, cards, index, playCard}) => {
    ...
    else if (cards.length === 6) rotationArray = [{deg: -15, y: 60}, {deg: -10, y: 20}, {deg: -3, y:  1}, {deg: 3, y: 1}, {deg: 10, y: 20}, {deg: 15, y: 60}]    
    ...
    return (
    <div className="card" onClick={() => playCard(card.str, card)} onMouseEnter={() => hoverZoom(index, true)} onMouseLeave={() => hoverZoom(index, false)} style={{rotate: `${rotationArray[index].deg}deg`, top: `${rotationArray[index].y}px` }}>
